...
export class AuthService{
    ...
    signup(e_mail:string,pass:string){
       return  this.http.post<AuthResponseData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB3U_1jzOZFesVmTCo9aRBV0kMQdgQF2WY',
            {
                email:e_mail,
                password:pass,
    ...
    login(e_mail:string,pass:string){
        return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB3U_1jzOZFesVmTCo9aRBV0kMQdgQF2WY',
        {
            email:e_mail,
            password:pass,
            returnSecureToken:true
